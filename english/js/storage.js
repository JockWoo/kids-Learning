/**
 * Little Math Explorer — Storage Engine (English Edition)
 */

const STORAGE_KEYS = {
  SETTINGS: 'little_math_explorer_en_settings',
  STATS: 'little_math_explorer_en_stats'
};
...
const DEFAULT_SETTINGS = {
  ...
  allowedModes: ['letter', 'word', 'order']
};
